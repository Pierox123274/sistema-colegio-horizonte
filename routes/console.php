...
use App\Jobs\SendAcademicRemindersJob;
use App\Jobs\SendFinancialRemindersJob;
use App\Jobs\SendInstitutionDailySummaryJob;
use App\Jobs\SendMeetingRemindersJob;
use App\Jobs\SendSystemNotificationsJob;
...
Schedule::job(new SendAcademicRemindersJob)->hourly();
Schedule::job(new SendMeetingRemindersJob)->everyFifteenMinutes();
Schedule::job(new SendFinancialRemindersJob)->dailyAt('08:15');
Schedule::job(new SendSystemNotificationsJob)->everyThirtyMinutes();
