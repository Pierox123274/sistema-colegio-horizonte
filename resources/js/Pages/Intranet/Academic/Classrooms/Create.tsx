...
export default function ClassroomsCreate() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        form.post(route('intranet.academic.classrooms.store'));
    };

    return (
        <IntranetLayout title="Nueva aula">
            <Head title="Nueva aula — Horizonte" />
            ...
            <PageContainer width="default">
                ...
                <SectionTitle
                    title="Nueva aula"
                    description="El código es único en todo el sistema. La sección es opcional."
                />
