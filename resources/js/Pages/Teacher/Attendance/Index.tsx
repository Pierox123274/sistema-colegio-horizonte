...
type P = PageProps<{
    ...
    links: { register: string; history: string; reports: string };
            ...
            <PageContainer>
                {teacher_portal_scoped && has_teaching_assignments === false ? (
                    <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
                        Sin secciones asignadas en el año activo: el selector y el historial
                        reciente aparecen vacíos hasta que administración registre su carga
                        docente.
                    </div>
                ) : null}
                ...
                <SectionTitle
                    title="Asistencia"
                    description="Consulta rápida y acceso al registro masivo del ERP (misma lógica y permisos que en administración)."
                    actions={
                ...
                <p className="mb-4 text-sm text-plomo">
                    ...
                    >
                        Abrir historial completo en el ERP
                    </Link>{' '}
                    si necesita filtros avanzados.
                </p>

                <TableContainer
                    title="Últimos registros"
                    description="Vista resumida; el detalle por alumno se abre en el módulo de asistencia del ERP."
                >
