...
export default function TeacherAdaptiveLearning() {
    const { low_students, weak_topics } = usePage<Props>().props;
    const topicEntries = Object.entries(weak_topics);

    return (
        <TeacherLayout title="Aprendizaje adaptativo">
            <Head title="Aprendizaje adaptativo" />
            <PageContainer>
                <SectionTitle
                    title="Aprendizaje adaptativo"
                    description="Visibilidad de estudiantes con nivel básico o sin diagnóstico, y temas débiles en tus secciones."
                />
