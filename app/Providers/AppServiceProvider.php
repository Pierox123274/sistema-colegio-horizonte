...
use App\Policies\GamificationPolicy;
...
use App\Policies\VirtualMeetingPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(VirtualMeeting::class, VirtualMeetingPolicy::class);
        ...
        Gate::policy(GamificationDashboard::class, GamificationPolicy::class);
